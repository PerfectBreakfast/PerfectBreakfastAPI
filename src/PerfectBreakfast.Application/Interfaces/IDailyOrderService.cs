...
namespace PerfectBreakfast.Application.Interfaces
{
    public interface IDailyOrderService
    {
        ...
        public Task<OperationResult<Pagination<DailyOrderForPartnerResponse>>> GetDailyOrderInitAndCompleteByPartner(int pageIndex = 0, int pageSize = 10);
        ...
        public Task<OperationResult<Pagination<DailyOrderForDeliveryResponse>>> GetDailyOrderInitAndCompleteByDelivery(int pageIndex = 0, int pageSize = 10);
